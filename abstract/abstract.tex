...
\jtitle{\fontsize{13pt}{0pt}拡散の普遍性を用いた相互に通信する分子通信系シミュレーション法構築}
\etitle{Construction of Simulation Method for Mutual Molecular Communication System \\ using Universality of Diffusion}
\lab{堀}
\no{82411805}
\name{川口竜輝}
\begin{document}
